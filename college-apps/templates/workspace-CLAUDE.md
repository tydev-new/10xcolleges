<!-- college-apps guardrails v1 — keep this line: skills use it to find and version this block -->
...
- **Never state a college number from memory.** Admit rates, costs, deadlines, and test
  ranges are looked up fresh and carry source + vintage. "Not found — needs checking" is
  a real answer. A deadline counts only from the college's own admissions page.
