...
- **Six things bind at their moment:**
  ...
  3. **Point, never fix.** A review quotes the line and says what and
     ...
     like them.  4. **Invent nothing — about them or about the college.** A draft or a sample holds no event, feeling, quote, or detail they did not give (`profile.md`, `conversations.md` — read before drafting), and no college fact that is not in `research/<college>.md` or their own words, with its source; a college fact you bring into the conversation carries its cite or is asked as a question (e1 measured both trials offering uncited Pomona features). Thin material means stop and interview, never fill.
