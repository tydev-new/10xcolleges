...
|:---:|---|---|---|---|:---:|
| **0** | **`college-app`** | **Lead Counselor & Meta-Orchestrator:** Discovers workspace, applies "Single Next Step" triage, routes across specialist skills, and executes multi-intent requests. | Coordinates validators, manages `meta.json` | [`schemas/meta.md`](college-apps/skills/core/schemas/meta.md) | **100% PASS** (`m1-college-app`) |
| **1a** | **`student-intake`** | **Student Record & Criteria Engine:** Gathers student profile, activities, and reflections from conversation or school packets. Captures hard budget filters and deal-breakers. | [`check_record.py`](college-apps/skills/core/scripts/check_record.py) | [`schemas/profile.md`](college-apps/skills/core/schemas/profile.md)<br>[`schemas/criteria.md`](college-apps/skills/core/schemas/criteria.md) | **100% PASS** (`i1-intake-rounds`) |
| **1b** | **`major-fit`** | **Academic Direction & Major Strategy:** Analyzes departmental admit rate disparities, pairs primary majors with adjacent pathways, and audits internal transfer hurdles. | [`check_major.py`](college-apps/skills/core/scripts/check_major.py) | [`schemas/academic-direction.md`](college-apps/skills/core/schemas/academic-direction.md) | **100% PASS** (Unit Suite) |
| **2** | **`college-list`** | **Balanced College List Engine:** Formulates balanced 8–12 school lists enforcing the non-negotiable 2-safety floor (both academic and financial under family budget). | [`check_list.py`](college-apps/skills/core/scripts/check_list.py) | [`schemas/colleges.md`](college-apps/skills/core/schemas/colleges.md) | **100% PASS** (`l1-list-build`) |
| **3** | **`college-research`** | **Grounded College Dossier Builder:** Gathers verified Common Data Set (CDS §C1, §C9) stats, departmental lab spaces, campus culture, and deadlines into grounded dossiers. | [`check_research.py`](college-apps/skills/core/scripts/check_research.py) | [`schemas/research.md`](college-apps/skills/core/schemas/research.md) | **100% PASS** (`r1-research-school`) |
| **4** | **`financial-aid`** | **Affordability & Net Price Engine:** Audits Net Price Calculator (NPC) figures, models need-based and merit aid, and schedules FAFSA and CSS Profile milestones. | [`check_aid.py`](college-apps/skills/core/scripts/check_aid.py) | [`schemas/financial-aid.md`](college-apps/skills/core/schemas/financial-aid.md) | **100% PASS** (`f1-financial-aid`) |
| **5** | **`essay-coach`** | **Anti-Ghostwriting Essay Engine:** Guides students through personal statements and supplements: builds prompt rubrics, explores life angles, and provides draft-by-draft feedback. | [`check_draft.py`](college-apps/skills/core/scripts/check_draft.py) | [`schemas/essay.md`](college-apps/skills/core/schemas/essay.md) | **100% PASS** (`e3-review-rounds`) |
| **6** | **`rec-request`** | **Teacher Recommendation Engine:** Audits faculty candidates for balanced STEM + Humanities coverage, provides in-person ask scripts, brag sheets with friction moments, and FERPA advice. | [`check_rec.py`](college-apps/skills/core/scripts/check_rec.py) | [`schemas/recs.md`](college-apps/skills/core/schemas/recs.md) | **100% PASS** (`k1-rec-request`) |
| **7** | **`app-tracker`** | **Multi-Tier Deadline & Spreadsheet Engine:** Plans backwards schedules with a 7-day server crash buffer, 72-hour portal audit protocol, and generates a live 5-sheet spreadsheet. | [`make_tracker.py`](college-apps/skills/core/scripts/make_tracker.py) | [`schemas/tracker.md`](college-apps/skills/core/schemas/tracker.md) | **100% PASS** (Date Suite: 19/19) |
| **8** | **`counselor-package`** | **Counselor Review & Options Packet:** Compiles an interim review package (`package.html` / PDF) opening with 4 high-leverage institutional questions, and fills the official school packet (`packet.docx`). | [`build_package.py`](college-apps/skills/core/scripts/build_package.py)<br>[`fill_packet.py`](college-apps/skills/core/scripts/fill_packet.py) | [`schemas/counselor.md`](college-apps/skills/core/schemas/counselor.md) | **100% PASS** (`p1-counselor-package`) |
...
- **System Architecture & Data Contracts:** [`college-apps/skills/core/references/data-model.md`](college-apps/skills/core/references/data-model.md)
- **Counselor Voice & Persona Guidelines:** [`college-apps/skills/core/references/voice.md`](college-apps/skills/core/references/voice.md)
- **Citation & Provenance Standards:** [`college-apps/skills/core/references/citations.md`](college-apps/skills/core/references/citations.md)
